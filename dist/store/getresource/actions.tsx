...
export const resourceresult = (command: I.RESOURCE, data: any, restid: string | null, js: string | null, vars?: object): I.IResourceResult => {
    return {
        type: command,
        data: data,
        restid: restid,
...
export const resourceRead = (command: I.RESOURCE) => {
    ...
    return (dispatch: any) => {
        ...
        axios.get(url).then(res => {
            dispatch(resourceresult(command, res.data, null, null, undefined));
        });
    }
}